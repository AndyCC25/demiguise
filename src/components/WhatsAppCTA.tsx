...
// TODO: Replace NUMERO_1 and NUMERO_2 with real WhatsApp numbers in international format
// e.g. "50212345678" for Guatemala, no + or spaces
const CONTACTS = [
  { label: "Contactar — Persona 1", number: "59170383758" },
  { label: "Contactar — Persona 2", number: "59170383758" },
] as const
